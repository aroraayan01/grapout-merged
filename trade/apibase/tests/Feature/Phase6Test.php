...
class Phase6Test extends TestCase
{
    ...
    public function test_public_plans_endpoint(): void
    {
        ...
        $this->assertTrue($slugs->contains('gold'));
        $this->assertTrue($slugs->contains('platinum'));
        $this->assertFalse($slugs->contains('family'), 'the older personal-assistant plans are no longer offered');
