...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Under grapout.com/trade every URL Laravel builds — signed links,
        // emails, redirects — must carry the prefix. APP_URL has it.
        if ((string) env('APP_URL_PREFIX', env('APP_BASE_PATH', '')) !== '' && config('app.url')) {
