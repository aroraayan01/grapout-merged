 ...
 * GrapOut hears from the platform, which is what this class sends. Somebody a
...
class SignInCodeNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $mail = (new MailMessage)
            ->subject('Your GrapOut sign-in code: ' . $this->otp->code)
            ->greeting('Signing in to GrapOut')
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            'kind' => 'sign_in_code',
            'message' => "Your GrapOut sign-in code is {$this->otp->code}."
    ...
    public function toPush(object $notifiable): array
    {
        return [
            ...
            'body' => $this->deviceName
                ...
                : 'Someone is signing in to your GrapOut account.',
            'tag' => 'sign-in-code',
            'url' => '/',
            'kind' => 'sign_in_code',
            'channel' => 'alerts',
