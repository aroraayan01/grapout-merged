...
class Alerts
{
    ...
    private const KINDS = [
        ...
        'booking_confirmed' => 'social',
        'booking_rescheduled' => 'social',
        'booking_cancelled' => 'social',
        'file_shared' => 'social',
        'note_shared' => 'social',
     ...
     * "GrapOut" — so the bold half of every alert on the lock screen carried no
    ...
    private const CATEGORIES = [
        ...
        'social' => ['social_v1', 'normal', 86400, 'GrapOut'],
