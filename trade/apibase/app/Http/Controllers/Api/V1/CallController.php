...
class CallController extends Controller
{
    ...
    public function initiate(Request $request, Conversation $conversation): JsonResponse
    {
        ...
        abort_if($me->featureBlocked('calls'), 403, 'Calls are switched off for this account by the GrapOut team.');
        ...
        if ($conversation->type === 'direct') {
            ...
            abort_if($target->featureBlocked('calls'), 403, 'They have switched calls off. Send a message instead.');
