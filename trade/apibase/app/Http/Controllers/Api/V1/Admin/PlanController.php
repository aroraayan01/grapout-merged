...
class PlanController extends Controller
{
    ...
    {
        abort_unless($request->user()->isSuperAdmin(), 403, 'Only an admin can edit plans.');
    ...
    public function assign(Request $request, User $user): JsonResponse
    {
        ...
        app(\App\Services\SubscriptionEntitlementService::class)->forget($user);
        \App\Services\PageRanker::recomputeForOwner($user->id);
