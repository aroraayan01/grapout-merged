    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'profile' => $this->whenLoaded('profile', fn () => [
                ...
                'role_function' => $this->profile?->role_function,
            ...
            // What the GrapOut team has switched off. Read by the app to hide the buttons; enforced on the server regardless.
            'features' => ['calls' => ! $this->featureBlocked('calls'), 'meetings' => ! $this->featureBlocked('meetings')],
            'blocks' => $this->when((bool) $request->user()?->isSuperAdmin() || (bool) $request->user()?->roles?->contains('slug', 'admin'), ['calls' => (bool) $this->calls_disabled, 'meetings' => (bool) $this->meetings_disabled, 'grap_leads_granted' => (bool) $this->grap_leads_granted, 'connection_daily_limit' => $this->connection_daily_limit]),
