    ...
    'connections' => [
        ...
        'reverb' => [
            ...
            'client_options' => [
                ...
                // A websocket server that is down must cost a request a
                // moment, not the library's thirty-second default: the
                // broadcast is dropped and the response still goes out.
                'connect_timeout' => (float) env('REVERB_CONNECT_TIMEOUT', 1),
                'timeout' => (float) env('REVERB_TIMEOUT', 4),
            ],
        ],
