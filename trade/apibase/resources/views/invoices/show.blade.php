...
<head>
<meta charset="utf-8">
<title>{{ $invoice->invoice_number }} — GrapOut Invoice</title>
<style>
...
<body>
  <div class="row" style="margin-top:0">
    ...
    <div style="text-align:right">
      <strong>{{ $invoice->billing_snapshot['seller']['name'] ?? 'GrapOut' }}</strong><br>
  ...
  <table>
    ...
    <tr>
      <td>
        GrapOut {{ $invoice->plan_name }} plan — {{ $invoice->billing_frequency }} billing<br>
  ...
  <p class="muted" style="margin-top:32px">
    This is a computer-generated invoice for your GrapOut subscription. Amounts are in {{ $invoice->currency }}.
  </p>
